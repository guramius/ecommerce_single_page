...
const Counter = () => {
  ...
  return (
    <div className="flex items-center">
        <div className="flex items-center rounded-[10px] bg-[#F6F8FD] px-[23px] py-[16px] gap-[45px]">
            <img onClick={decreaseCount} src={minuse} alt="minuse" />
            <p>{count}</p>
            <img onClick={incriseCount} src={plus} alt="minuse" />
        </div>
        <div className="flex items-center justify-center gap-[15px]  w-[272px] h-[56px] flex-shrink-0 rounded-[10px] bg-[#FF7E1B] shadow-[0px_20px_50px_-20px_#FF7E1B]">
            ...
            <button className="text-white" onClick={addCountBUtton}>Add to cart</button>
            <p className="absolute top-[100px]">{addCount}</p>
